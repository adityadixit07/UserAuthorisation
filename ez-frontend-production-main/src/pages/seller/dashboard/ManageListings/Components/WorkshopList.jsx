    ...
    return (
        <div className="flex flex-col flex-wrap gap-4">
            ...
            {workshopData?.map((workshop, index) => (
                <div key={index} className="flex flex-col md:w-[80%] md:flex-row items-stretch p-4 border border-[rgb(192,197,197)] border-t-[12px] border-t-green-400 rounded-xl">
                    ...
                    <div className="md:ms-5 w-full">
                        ...
                        <div className="w-full flex justify-between items-center md:my-4">
                            <button className="flex gap-3 items-center bg-green-500 rounded-lg p-2 px-4 font-semibold text-white">
                                Edit Workshop <AiFillRightCircle className="fill-white" />
                            </button>
