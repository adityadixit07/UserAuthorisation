  ...
  return (
    <>
      ...
      <div className="bio-top-header flex items-center">
        ...
        <h1>EDUCATION</h1>
        <button><BiEdit className='ms-5 text-white' onClick={editSectionEducation} /></button>
      </div>
        ...
        <div className="lg:w-10/12 w-9/12 flex flex-col lg:flex-row px-2 lg:px-0">
          ...
          <div className="school-desc w-full lg:w-4/12 mt-2 lg:mt-0">
            <div className="qualification flex">
              <div className="course bg-white px-1 text-blue-600	">High School</div>
              <div className="year lg:ml-14 md:ml-3 ml-1 bg-white px-1 text-lime-500">2016</div>
            </div>
            <div className='mt-2 hidden lg:flex'>
              <div className="bio-second-header-icon bio-second-header-icon-inside">
                <MdSchool />
              </div>
              <div className='introduction introduction-inside px-2 ml-2'>School</div>
            </div>
          </div>
        </div>
      </div>
      <div className="school-box-wrapper mt-3 flex items-center p-2 px-3">
        ...
        <div className="lg:w-10/12 w-9/12 flex flex-col lg:flex-row px-2 lg:px-0">
          ...
          <div className="school-desc w-full lg:w-4/12 mt-2 lg:mt-0">
            <div className="qualification flex">
              <div className="course bg-white px-1 text-blue-600	">Intermediate</div>
              <div className="year lg:ml-14 md:ml-3 ml-1 bg-white px-1 text-lime-500">2018</div>
            </div>
            <div className='mt-2 hidden lg:flex'>
              <div className="bio-second-header-icon bio-second-header-icon-inside">
                <MdSchool />
        ...
        <div className="lg:w-10/12 w-9/12 flex flex-col lg:flex-row px-2 lg:px-0">
          ...
          <div className="school-desc w-full lg:w-4/12 mt-2 lg:mt-0">
            <div className="qualification flex">
              ...
              <div className="year lg:ml-14 md:ml-3 ml-1 bg-white px-1 text-lime-500">2021</div>
            </div>
            <div className='mt-2 hidden lg:flex'>
              <div className="bio-second-header-icon bio-second-header-icon-inside">
                <MdSchool />
              </div>
              <div className='introduction introduction-inside px-2 ml-2'>College</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="lg:w-10/12 w-9/12 flex flex-col lg:flex-row px-2 lg:px-0">
          ...
          <div className="school-desc w-full lg:w-4/12 mt-2 lg:mt-0">
            <div className="qualification flex">
              ...
              <div className="year lg:ml-14 md:ml-3 ml-1 bg-white px-1 text-lime-500">2023</div>
            </div>
            <div className='mt-2 hidden lg:flex'>
              <div className="bio-second-header-icon bio-second-header-icon-inside">
                <MdSchool />
