...
function UIUX() {
  return (
    <>
     <div id='UIUX' className='w-full mt-5'>
            <div className='flex p-5 gap-5 items-center'>
              <TbHandFinger className=' rotate-90' size={30} /><h3 className='text-2xl font-bold'>UI/UX</h3>
            </div>
          </div>
          <div className='w-full grid grid-cols-1 mb-3 md:flex gap-3'>
            {/* cards */}

            {
              cards.map((data, index) => {
                return <div className='w-full md:w-1/3 rounded-[10px] bg-[#002404]' key={index}>
                  ...
                  <div className='flex justify-around items-center bg-slate-50 p-2 m-1 rounded-[10px]'>
